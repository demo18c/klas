...
export default function Decoy(props) {
	const group = useRef();
	const { nodes, materials } = useGLTF('/silvusafterchromeex.glb');
	return (
		<group ref={group} {...props} dispose={null}>
			<group position={[-0.47, 1.41, -0.68]} scale={[0.27, 1.11, 0.59]}>
				...
				<group position={[0.02, 2.83, 0.62]} scale={[1.23, 0.64, 0.44]}>
					...
					<mesh
						material={materials['CC0Textures/Plastic006/1K-JPG']}
						geometry={nodes.CylinderPlate.geometry}
					/>
				</group>
				<group position={[-0.06, 2.83, -0.64]} scale={[1.23, 0.64, 0.44]}>
					...
					<mesh
						material={materials['CC0Textures/Plastic006/1K-JPG']}
						geometry={nodes.Cylinder001Plate.geometry}
					/>
				</group>
				<mesh
...
useGLTF.preload('/silvusafterchromeex.glb');
